...
def main():
    ...
    put_row([put_markdown("### Source Transcript").style('color:#5b5b5b;border: 1px solid #4fccda; border-radius: 15px; text-align: center'),
    put_markdown("### Machine Translation").style('color: #5b5b5b;border: 1px solid #4fccda; border-radius: 15px; text-align: center')
    ])
     
    put_row([
        put_scrollable([put_scope('transcriptpage'),put_row([put_scope("subbuttons")])], height=(100,None), keep_bottom=True, border=True), 
        put_scrollable([put_scope('translationpage')], height=(100,None), keep_bottom=True, border=True)
        ])
   ...
   # put_collapse('Entities', [put_scope("entitysection")],open=True)
    ...
    def opencanvas():    
        put_scrollable([
            ...
            put_html("""<iframe src="http://www.translation-1.com/wp-content/uploads/sightconsecscripts/2/index.html" style="width: 720px; height: 2700px; border: none"></iframe>"""),
...
https://azure.microsoft.com/tr-tr/services/cognitive-services/text-analytics/"""},
    {'title': 'Contact', 'content': 'cihan.unlu[at]yeniyuzyil.edu.tr'}]).style('padding-top: 5px; padding-right: 120px; padding-bottom: 0px; padding-left: 120px; width: %100; border-radius: 20px; font-size: 14px; box-sizing: border-box; border-color: #4fccda; position: relative; text-align: justify')
